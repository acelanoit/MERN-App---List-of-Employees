...
// This section will help you create the default records:
app.post("/home", function (req, res) {
  const defaultRecords = req.body;
  Record.insertMany(defaultRecords, function (err) {
    if (!err) {

      // When the React app makes a POST request to the /home route, respond with a JSON object:
      res.json({ message: "Successfully restored default records." });
    } else {
      res.json(err);
    }
  });
...
// This section will help you delete all records:
app.delete("/home", function (req, res) {

  Record.deleteMany({}, function (err) {
    if (!err) {

      // When the React app makes a DELETE request to the /home route, respond with a JSON object:
      res.json({ message: "Successfully deleted all records." });
    } else {
      res.json(err);
    }
  });
